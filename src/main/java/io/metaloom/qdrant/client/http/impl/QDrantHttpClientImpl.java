...
public class QDrantHttpClientImpl extends AbstractQDrantClient {
	...
	@Override
	public RequestBuilder actionBuilder(String method, String path, JSONObject... json) {
	 ...
	 */
	public JSONObject executeSync(Request request) throws HttpErrorException {
	 ...
	 */
	public Single<JSONObject> executeAsync(Request request) {
