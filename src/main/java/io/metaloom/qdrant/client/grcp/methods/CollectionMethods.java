...
import static io.metaloom.qdrant.client.grcp.GrcpUtil.collectionsAsyncStub;
import static io.metaloom.qdrant.client.grcp.GrcpUtil.collectionsStub;

import java.util.List;
import java.util.Objects;

import io.metaloom.qdrant.client.http.ClientSettings;
import qdrant.Collections.AliasOperations;
import qdrant.Collections.ChangeAliases;
import qdrant.Collections.ChangeAliases.Builder;
import qdrant.Collections.CollectionOperationResponse;
import qdrant.Collections.CollectionParamsDiff;
import qdrant.Collections.CreateCollection;
import qdrant.Collections.DeleteCollection;
import qdrant.Collections.GetCollectionInfoRequest;
import qdrant.Collections.GetCollectionInfoResponse;
import qdrant.Collections.HnswConfigDiff;
import qdrant.Collections.ListCollectionsRequest;
import qdrant.Collections.ListCollectionsResponse;
import qdrant.Collections.OptimizersConfigDiff;
import qdrant.Collections.UpdateCollection;
import qdrant.Collections.VectorParams;
import qdrant.Collections.VectorsConfig;
import qdrant.Collections.WalConfigDiff;
...
public interface CollectionMethods extends ClientSettings {
	...
	default GrpcClientRequest<CollectionOperationResponse> updateCollectionAliases(List<? extends AliasOperations> actions, Integer timeout) {
		...
		Builder request = ChangeAliases.newBuilder()
